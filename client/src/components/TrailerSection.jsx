...
const TrailerSection = () => {
    ...
    return (
    <div id="trailers" className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
            <p className='text-grey-300 font-medium test-lg mas-w-[960px] mx-auto'>Trailers</p>
